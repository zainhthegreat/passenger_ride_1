...
class _MapsState extends State<Maps> {
                          ...
                          child: Row(
                            ...
                            children: [
                              FlatButton(
                                  ...
                                  child: Image.asset(
                                    'assets/ui/drawerIcon/menu-left-alt.png',
                                    width: 22,
                                  )),
  ...
  getTopic(i) {
    if (i == 0) return _headingText(' ');

    if (i == 1) return _headingText(' ');

    if (i == 2) return _headingText('Arriving');

    if (i == 3) return _headingText('Arrived');

    if (i == 4) return _headingText('Reaching Destination');

    if (i == 5) return _headingText('');
  }

  getMiddleWidget(i) {
    if (i != JournyStoryState.main.index &&
        i != JournyStoryState.finidngCar.index) {
  ...
  getBottomWidget(i) {
      ...
      return Padding(
        ...
        child: Bottom_widgets.WhereToGo(context, () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => Select_car_1(widget.user),
              ));
        }),
      );
    ...
    if (i == JournyStoryState.FindingMatch.index)
      return Bottom_widgets.RateDriver(context, () {
        context.read<JourneyProvider>().main();
      });
    ...
    return Text(
      ...
      style: GoogleFonts.poppins(
          color: Mycolor.h1color, fontSize: 16, fontWeight: FontWeight.normal),
    );
